...
export default function Withdrawal({ params }, props) {
          ...
          <Grid container spacing={3}>
            <Grid item xs={3}>
              <div className={paymentStyles.paymentButtonContainer}>
                <NextLink href={"/pages/paymenthistory.js"} passHref>
                  <button className={paymentStyles.buttons}>
                    PAYMENT HISTORY
                  </button>
                </NextLink>
                <NextLink href={"/pages/requestwithdrawal"} passHref>
                  <button className={paymentStyles.buttons}>
                    REQUEST WITHDRAWAL
                  </button>
                </NextLink>
                <NextLink href={"/pages/clientpayment"} passHref>
                  <button className={paymentStyles.buttons}>
                    CLIENT PAYMENTS
                  </button>
                </NextLink>
